...
Every time fish displays a prompt, it’ll try to fix up your terminal so that you don’t end up in weird situations like this. I think [this is some of the code in fish to prevent broken terminals][8].

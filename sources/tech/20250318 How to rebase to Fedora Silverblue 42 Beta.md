[#]: subject: "How to rebase to Fedora Silverblue 42 Beta"
[#]: via: "https://fedoramagazine.org/how-to-rebase-to-fedora-silverblue-42-beta/"
...
### Known Issues
  ...
  * [Incorrect check for static configs with bootupd leads to no /boot/loader/grub.cfg after reboot][4]
We advise users to hold off on testing bootupd on their updated Fedora Atomic Desktops & IoT systems until this bug is resolved.
...
**Question: I have[rpm-fusion][5] layered and I got errors during rebase. How should I do the rebase?**

Answer: If you have [rpm-fusion][5] layered on your Silverblue installation, you should do the following before rebase:
...
Yes, you can follow the _Rebasing using the terminal_ part of this guide for every ostree edition of Fedora. Just use the corresponding branch. For example for Kinoite use fedora:fedora/42/x86_64/kinoite
...
[1]: https://fedoramagazine.org/wp-content/uploads/2025/03/silverblue-f42_beta-816x345.jpg
[2]: https://docs.fedoraproject.org/en-US/fedora-silverblue/
[3]: https://fedoramagazine.org/give-fedora-silverblue-a-test-drive/
[4]: https://bugzilla.redhat.com/show_bug.cgi?id=2312453
